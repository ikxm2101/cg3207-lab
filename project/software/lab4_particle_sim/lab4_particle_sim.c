...
// Global array - memory access patterns are important for branch prediction
...
int main()
{
    ...
    init_particles(); // Initialize with some pattern
    int frame_count = 0;
    ...
    while (1)
    {
        ...
        update_particles(); // Compute-intensive portion
